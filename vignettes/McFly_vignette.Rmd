...
vignette: >
  %\VignetteIndexEntry{mcfly - an R package to evaluate the influence of the adaptation rate of species niche positions on biological diversity gradients across metacommunities}
...
We will run all the analysis using occurrence data of avian species from Furnaridae family. This data is a part of the mcfly package, to read it type:
```{r readData, eval=FALSE}
data("Furnaridae")
```
Furnaridae dataset comprises the occurence of 223 Furnaridae species distributed through the entire Neotropical region. The phylogenetic hypothesis used in this analysis was obtained from [BirdTree](https://birdtree.org/) and are presented in phylo_Furnaridae data, also presented in mcfly package.
