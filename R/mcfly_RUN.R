...
mcfly_RUN <- function(OU.alpha.v, comm, subset, occurrence, tree, mat.env, landscape, JM, n.timestep, spp.freq, W.r,
                      sigma, theta, root.value, scenario.ID, sim.ID, output.dir.path, reps = 1){
