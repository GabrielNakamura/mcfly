...
- [ ] Inserir data.frame com coordenadas espaciais, obs.entropy e mean.sim.entropy no output
- [ ] Substituir Species.Pools por Data.Attributes,  contendo spp.phylogeny, spp.metacommunity, n.sites, max.dist.mst., tempo máximo da árvore (raiz tip)
