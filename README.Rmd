...
- [x] incluir módulo gráfico, incluindo density functions para os posteriores e a curva dlk x r.
- [ ] e incluir gráfico meia vida. calcular o hpd da meia vida com o log e depois converter
- [ ] CRAN release
